...
We use the very powerful [OpenAIR package](https://davidcarslaw.github.io/openair/) to analyse trajectories.
...
```{r}
plot_traj_clusters <- function(trajs, n_clusters=5, statistics="frequency"){
